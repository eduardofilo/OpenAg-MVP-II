...
def getYellowTempChart():
    r = requests.get('http://127.0.0.1:5984/mvp_sensor_data/_design/doc/_view/attribute_value?startkey=["temp_yellow",{}]&endkey=["temp_yellow"]&descending=true&limit=60')
    #print r
    ...
    #need to reverse order to go from earliest to latest
    v_lst.reverse()
    line_chart.add('Yellow Water Tank Temp', v_lst)
